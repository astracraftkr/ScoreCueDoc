...
> This is a translation provided for convenience. The [Korean version]({{ '/ko/business/' | relative_url }})
> is the authoritative text; if the two differ, the Korean version prevails.

Business information disclosed under the Korean Act on Consumer Protection in Electronic Commerce.
...
All enquiries — app usage, payments, refunds, and privacy — go to the email address above.
We aim to reply within three business days.

- For payments and refunds, see the [Payment & Refund Policy]({{ '/en/refund/' | relative_url }}).
- For access, correction, or deletion of personal data, follow the process in the
  [Privacy Policy]({{ '/en/privacy/' | relative_url }}).

## Payment processing

**All ScoreCue payments are processed by Google Play or the Apple App Store.** We neither collect
nor store payment credentials such as card numbers, and cancellations and refunds follow each
store's own policies and procedures. See the
[Payment & Refund Policy]({{ '/en/refund/' | relative_url }}) for details.
